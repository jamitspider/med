...
def step_click_on_verification_link(context):
    ...
    context.driver.find_element_by_partial_link_text('http://ant-hills.com:8080/accounts/confirm-email/').click()
    
@then('ensure that user should redirect to {text} to verify email')   
